...
exports.hnsr = {
  ...
  MAX_CONTACTS: 16,
  ROUTING_BUCKET_SIZE: 16,
  MAX_ROUTING_CONTACTS: 2048,
  MAX_ROUTING_PER_NETGROUP: 2,
  MAX_FIND_QUERIES: 32,
  MAX_RENDEZVOUS_DIALS: 8,
  ROUTE_REPLICATION: 8,
  MIN_ROUTE_STORES: 3,
  MAX_DATA_SIZE: 16384,
  ...
  MAX_PREFIX_REQUESTS_PER_SECOND: 128,
  MAX_PREFIX_BYTES_PER_SECOND: 4 * 1048576,
  MAX_ADMISSION_PREFIXES: 4096,
  MAX_PUTS_PER_MINUTE: 32,
  MAX_GETS_PER_MINUTE: 120,
  MAX_VERIFICATIONS_PER_MINUTE: 128,
  MAX_STORES_PER_PEER: 256,
  MAX_STORES_PER_PREFIX: 1024,
  MAX_REQUESTER_CIRCUITS: 8,
  MAX_IP_CIRCUITS: 8,
  MAX_NETGROUP_CIRCUITS: 16,
  MAX_ENDPOINT_CIRCUITS: 16,
  MAX_ACTIVE_RELAY_CIRCUITS: 1024,
  MAX_ACTIVE_WEB_CIRCUITS: 256,
  NODE_RELAY_BYTES_PER_SECOND: 4 * 1024 * 1024,
  WEB_RELAY_BYTES_PER_SECOND: 1024 * 1024,
  STATE_FLUSH_INTERVAL: 60000,
  DEFAULT_REPUBLISH_INTERVAL: 300000,
  DEFAULT_REPUBLISH_RETRY: 30000,
  MAX_WEB_HEADER_SIZE: 16384,
  MAX_WEB_BODY_SIZE: 1048576,
  MAX_WEB_REQUESTS_PER_CIRCUIT: 16,
  WEB_IDLE_TIMEOUT: 120000,
  INNER_HANDSHAKE_TIMEOUT: 15000
};
