...
class Peer extends EventEmitter {
  ...
  sendVersion() {
    ...
    packet.services = this.options.getServices();
    this.localServices = packet.services;
...
class PeerOptions {
  ...
  constructor(options) {
    ...
    this.getServices = PeerOptions.getServices.bind(this);
  ...
  fromOptions(options) {
    ...
    if (options.getServices != null) {
      assert(typeof options.getServices === 'function');
      this.getServices = options.getServices.bind(options);
    }
