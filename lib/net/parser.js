...
class Parser extends EventEmitter {
  ...
  parseHeader(data) {
    ...
    let maxSize = common.MAX_MESSAGE;

    switch (type) {
      case packets.types.EXPERIMENTAL_GET_DNS_RELAY:
        maxSize = common.dnsRelay.MAX_REQUEST_PAYLOAD_SIZE;
        break;
      case packets.types.EXPERIMENTAL_DNS_RELAY:
        maxSize = common.dnsRelay.MAX_RESPONSE_PAYLOAD_SIZE;
        break;
      case packets.types.EXPERIMENTAL_ODOH:
        maxSize = common.odoh.MAX_PACKET_SIZE;
        break;
    }
